...
class Enemy
{
    constructor()
    {
        ...
        this.image = createImage('Imagenes/mosca2.png')
    }
    draw()
    {
        screen.drawImage(this.image, this.position.x, this.position.y, this.width, this.height)
    ...
    update(contador)
    {
        ...
        if(this.position.x > lienzo.width - this.width -50) this.position.x = lienzo.width - this.width -50
        if(this.position.y < 50) this.position.y = 50
        if(this.position.y > lienzo.height - this.height -50) this.position.y = lienzo.height - this.height -50
